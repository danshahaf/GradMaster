...
const IntegratedPractice = () => {
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <Navigation />
      <div className="container mx-auto px-4 py-8 mt-16 flex flex-col">
        <h1 className="text-3xl font-bold mb-6">Integrated Practice</h1>
        ...
        <Card className="p-6">
          ...
          <div className="mt-6 flex items-center w-full gap-4">
            ...
            <input 
              ...
              className="w-4/6 px-4 py-3 border rounded-md focus:outline-none bg-background"
            />

            <button className="bg-primary text-white px-4 py-2 w-1/6 rounded-md flex items-center justify-center gap-2">
              <MessageCircleQuestion />
              Explain
            </button>
...
export default IntegratedPractice;
