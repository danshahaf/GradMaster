        ...
        <NavigationMenuItem className="relative">
          ...
          <NavigationMenuContent>
            <ul className="min-w-[200px] p-2 bg-background border rounded-md shadow-lg">
              <li>
                <Link to="/study-materials" className="block p-2 hover:bg-primary hover:text-primary-foreground rounded-md">Study Materials</Link>
              </li>
              <li>
                <Link to="/progress-tracking" className="block p-2 hover:bg-primary hover:text-primary-foreground rounded-md">Progress Tracking</Link>
              </li>
              <li>
                <Link to="/tips-strategies" className="block p-2 hover:bg-primary hover:text-primary-foreground rounded-md">Tips & Strategies</Link>
              </li>
            </ul>
          </NavigationMenuContent>
        </NavigationMenuItem>
